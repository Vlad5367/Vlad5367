...
### 🌸 8 марта
*Описание:* Проект на Tkinter, представляющий собой открытку-поздравление с Международным женским днем 8 марта. Программа открывает красочную и интерактивную открытку для пользователя.
...
### 🗂️ Личное дело
*Описание:* Приложение для создания и управления личными делами абитуриентов. Пользователи войти в профиль и созать личное дело абитуриента.

[Репозиторий](https://github.com/Vlad5367/Vlad5367/tree/main/Personal)

### 🧠 Викторина
*Описание:* Викторина с вопросами по Python, предназначенная для проверки и улучшения знаний языка программирования. Вопросы варьируются от простых до сложных, охватывая различные аспекты Python.
...
### 🎲 Sudoku
*Описание:* Игра Судоку, в которой реализованы функции генерации головоломки и проверки решений. Встроенный алгоритм проверки гарантирует правильность введенных пользователем решений.
...
### ❌⭕ Крестики-нолики
*Описание:* Классическая игра Крестики-нолики с возможностью игры против компьютера. Игра имеет простой и интуитивно понятный интерфейс, что делает ее доступной для всех возрастов.
